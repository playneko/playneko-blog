                    ...
                    <div class="content">
                        ...
                        >
                            ...
                            <v-text-field
                                ...
                                required
                            ></v-text-field>
                            <Editor ref="toastuiEditor" height="700px" initialEditType="markdown" />
                        </v-form>
                    </div>
                    <div v-if="Object.keys(posts).length > 0 && !loadingBoard" class="content-button">
...
export default {
    ...
    methods: {
        fetchCategoryData: async function() {
            this.loading = true
            const baseURI = this.$proxyUrl + '/api/board/category/info'
            ...
            await this.$http.get(`${baseURI}?id=${this.params.catpage}`)
            .then((result) => {
            ...
            if (this.$isEmpty(this.subject)) {
                ...
                if (this.$isEmpty(getKakaoId, 1)) {
                    ...
                    if (confirm("게시글을 저장 하시겠습니까?")) {
                        ...
                        const baseURI = '/api/board/write/detail'
                        const params = {
                            boardCat: this.params.catpage,
                            userId: getKakaoId,
